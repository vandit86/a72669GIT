/**
* manipulate with data obtained from SNMPGetter class
* 
*
*/
...
*/
public void initInterfaceList (int ifNum, boolean isLoopback){
	...
	for (int i = 1 ; i<= ifNum; i++){
		...
		// don't add loopback interface to the ifList 
