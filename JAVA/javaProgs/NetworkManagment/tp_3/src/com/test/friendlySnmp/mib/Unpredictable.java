...
//--AgentGen END
{
  ...
  private static final LogAdapter LOGGER = 
      LogFactory.getLogger(Unpredictable.class);
...
//--AgentGen END
  ...
  /**
   * Constructs a Unpredictable instance without actually creating its
   * <code>ManagedObject</code> instances. This has to be done in a
   * sub-class constructor or after construction by calling 
   * {@link #createMO(MOFactory moFactory)}. 
   */
  protected Unpredictable() {
//--AgentGen BEGIN=_DEFAULTCONSTRUCTOR
//--AgentGen END
  }

  /**
   * Constructs a Unpredictable instance and actually creates its
   ...
   */
  public Unpredictable(MOFactory moFactory) {
  	this();
    createMO(moFactory);
...
//--AgentGen END
  ...
  public class UnpredictableEntryRow extends DefaultMOMutableRow2PC {
    ...
    public OctetString getRndNumber() {
     //--AgentGen BEGIN=unpredictableEntry::getRndNumber
     //--AgentGen END
      return (OctetString) super.getValue(idxRndNumber);
    }  
    
    public void setRndNumber(OctetString newColValue) {
    ...
    public void setValue(int column, Variable value) {
     ...
     //--AgentGen END
      switch(column) {
        case idxRndNumber: 
        	setRndNumber((OctetString)value);
        	break;
        default:
...
//--AgentGen END
  ...
  // Textual Definitions of MIB module Unpredictable
