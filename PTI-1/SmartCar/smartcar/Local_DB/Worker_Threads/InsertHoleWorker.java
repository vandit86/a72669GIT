...
public class InsertHoleWorker implements Runnable {
    ...
    public InsertHoleWorker(SmartCarDBHelper dbHelper, SQLiteDatabase local_DB){
    ...
    @Override
    public void run() {
        this.dbHelper.insertHoleData(local_DB,user_email,time_stamp,lat,lng,neigh);
    }
}
