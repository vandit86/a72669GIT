...
public class InsertTrafficWorker implements Runnable {
    ...
    public InsertTrafficWorker(SmartCarDBHelper dbHelper, SQLiteDatabase local_DB){
    ...
    @Override
    public void run() {
        this.dbHelper.insertTrafficData(local_DB,user_email,time_stamp,lat,lng,neigh);
    }
}
