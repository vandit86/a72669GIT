...
public class InsertBrakeWorker implements Runnable {
    ...
    public InsertBrakeWorker(SmartCarDBHelper dbHelper, SQLiteDatabase local_DB){
    ...
    @Override
    public void run() {
        this.dbHelper.insertBrakeData(local_DB,user_email,time_stamp,lat,lng,neigh);
    }
}
