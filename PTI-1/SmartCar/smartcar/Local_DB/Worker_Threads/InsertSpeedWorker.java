...
public class InsertSpeedWorker implements Runnable {
    ...
    public InsertSpeedWorker(SmartCarDBHelper dbHelper, SQLiteDatabase local_DB){
    ...
    @Override
    public void run() {
        this.dbHelper.insertSpeedData(local_DB,user_email,time_stamp,lat,lng,neigh);
    }
}
