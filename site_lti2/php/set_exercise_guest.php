...
// here we need to check the data in GET
if(isset($_GET['id_guest']) && isset($_GET['cod_exercicio'])
	...
	&& isset($_GET['data_real']) && isset($_GET['hora']) && isset($_GET['level']) && isset($_GET['pontuation'])){
	...
	$query = "INSERT INTO exercise_m_guest(id_guest,
		...
		'$num_correct_img', '$num_correct_sound', '$num_correct_both', '$data_real', 
		'$hora', '$level', '$pont')" or die("Error running the query: ".mysqli_error($link));   
