...
/*
 * Following code will list the results of a patient
 */
...
if(isset($_GET['id_patient'])){
	...
	$query = "SELECT * FROM exercise_m_patient WHERE id_patient = '$patient_id'" or die("Error running the query: ".mysqli_error($link));
	...
	$response["success"] = 0;
	$response["message"] = "No patient id, required field is missing";
